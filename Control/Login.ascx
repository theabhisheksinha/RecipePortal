...
<div class="loginboxlabelwrapper"><span class="content2">User Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Password</span></div>
<asp:TextBox ID="uname" cssClass="textboxsearch" TextMode=SingleLine Width="104px" Text="" runat="server" ToolTip="Enter username" />&nbsp;<asp:TextBox ID="upass" cssClass="textboxsearch" TextMode=Password Text="password" Width="104px" runat="server" ToolTip="Enter password" />&nbsp;<asp:Button ID="usubmit" runat="server" OnClick="Login_Click" cssClass="submitadmin" Text="Login" causesvalidation="true" validationgroup="LoginGroup" />
