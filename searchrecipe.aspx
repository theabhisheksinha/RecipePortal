...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <a onmouseover="Tip('<img src=&quot;RecipeImageUpload/<%# Eval("RecipeImage")%>&quot; width=&quot;150&quot; height=&quot;120&quot;>', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" class="dtcat" title="View <%# Eval("RecipeName")%> recipe" href='<%# Eval("ID", "recipedetail.aspx?id={0}") %>'><%# Eval("RecipeName") %></a>
