<%@ Page Language="C#" MasterPageFile="~/SiteTemplate2.master" EnableViewState="false" AutoEventWireup="true" CodeFile="pmread.aspx.cs" Inherits="pmread" Title="Reading Private Message" %>
...
<fieldset><legend>Reading Message</legend>
...
<div style="text-align: right; margin-top: 7px; margin-right: 12px;">
<asp:Button ID="btnReply" runat="server" CssClass="submitadmin" Text="Reply" OnClick="Reply_Click" />&nbsp;&nbsp;<asp:Button ID="btnForward" runat="server" CssClass="submitadmin" Text="Forward" OnClick="Forward_Click" />&nbsp;&nbsp;<asp:Button ID="btnDelete" runat="server" CssClass="submitadmin" Text="Delete" OnClick="Delete_Click" OnClientClick="return confirm('Are you sure you want to delete this message?');" />
</div>
</asp:Panel>
<br />
    </fieldset>
