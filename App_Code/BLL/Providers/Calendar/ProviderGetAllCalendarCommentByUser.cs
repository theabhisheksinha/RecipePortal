...
namespace XDRecipe.BL.Providers.Calendar
{
    ...
    /// </summary>
    public sealed class ProviderGetAllCalendarCommentByUser : Calendar
    {
        private static readonly ProviderGetAllCalendarCommentByUser Instance = new ProviderGetAllCalendarCommentByUser();

        static ProviderGetAllCalendarCommentByUser()
        {
        }

        ProviderGetAllCalendarCommentByUser()
        {
        }

        public static ProviderGetAllCalendarCommentByUser GetInstance()
        {
            return Instance;
        }
        ...
        private IDataReader GetData
        {
            ...
            {
                //Get data
                IDataReader dr = Blogic.ActionProcedureDataProvider.GetAllCalendarCommentedByUser(Author, OrderBy, SortBy, Index, PageSize);
                return dr;
            }
        }
