...
// FileName: ProviderOtherCalendarByThisAuthor.cs
// Author: Dexter Zafra
...
namespace XDRecipe.BL.Providers.Calendar
{
    ...
    /// </summary>
    public sealed class ProviderOtherCalendarByThisAuthor : Calendar
    {
        private static readonly ProviderOtherCalendarByThisAuthor Instance = new ProviderOtherCalendarByThisAuthor();

        static ProviderOtherCalendarByThisAuthor()
        {
        }

        ProviderOtherCalendarByThisAuthor()
        {
        }

        public static ProviderOtherCalendarByThisAuthor GetInstance()
        {
            return Instance;
        }
        ...
        private IDataReader GetData
        {
            ...
            {
                //Get data
                IDataReader dr = Blogic.ActionProcedureDataProvider.GetTop10OtherCalendarsByThisAuthor(UID, ID);
                return dr;
            }
        }
