...
// FileName: ProviderGetAllRecipebyAuthor.cs
// Author: Dexter Zafra
...
namespace XDRecipe.BL.Providers.Recipes
{
    ...
    /// </summary>
    public sealed class ProvidersGetAllRecipebyAuthor : Recipe
    {
        private static readonly ProvidersGetAllRecipebyAuthor Instance = new ProvidersGetAllRecipebyAuthor();

        static ProvidersGetAllRecipebyAuthor()
        {
        }

        ProvidersGetAllRecipebyAuthor()
        {
        }

        public static ProvidersGetAllRecipebyAuthor GetInstance()
        {
            return Instance;
        }
        ...
        private IDataReader GetData
        {
            ...
            {
                //Get data
                IDataReader dr = Blogic.ActionProcedureDataProvider.GetAllRecipeSubmittedByUser(AuthorName, OrderBy, Index, PageSize);
                return dr;
            }
        }

        public ExtendedCollection<Recipe> GetAllRecipeByAuthorResult()
        {
