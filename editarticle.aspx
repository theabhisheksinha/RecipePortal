<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" ValidateRequest="false" CodeFile="editarticle.aspx.cs" Inherits="editarticle" %>
...
<fieldset><legend>Editting an Article</legend>
...
<span class="cmaron"><asp:Label ID="lblauthorname" cssClass="cmaron" runat="server" /></span>
  ...
  <tr>
    ...
    <td width="74%">
<asp:dropdownlist id="ddlarticlecategory" runat="server" cssClass="ddl" AutoPostBack="false"></asp:dropdownlist>&nbsp;<img src="images/help.gif" align="absmiddle" border="0" onmouseover="Tip('<b>Note:</b> If you dont want to change category, do not select anything.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
</td>
  </tr> 
  <tr>
    <td width="26%"><span class="content12">Title:</span><span class="cred2">*</span></td>
    <td width="74%">
<input type="text" id="Title" name="Title" class="textbox" size="70" runat="server" onFocus="this.style.backgroundColor='#FFFBE1'" onBlur="this.style.backgroundColor='#ffffff'" onmouseover="Tip('65 characters maximum for the <b>Title</b>', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
    ...
    <td width="74%">
<textarea runat="server" id="Summary" class="mceNoEditor textbox" cols="82" rows="4" onmouseover="Tip('350 characters maximum for the <b>Summary</b>, and should not contain HTML tag.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
      <asp:RequiredFieldValidator runat="server"
...
<br />
<asp:Button runat="server" Text="Update" id="AddArticle" cssClass="submitadmin" OnClick="Update_Article" onmouseover="Tip('Before submitting, you can <b>preview</b> your article by clicking the preview button in the editor menu.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
</td>
  </tr>
</table>
 </div>
